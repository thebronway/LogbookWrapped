    ...
    >
      ...
      <div className="space-y-12">
        <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.3 }}>
          ...
          <p className="text-indigo-300 text-lg font-bold uppercase tracking-widest mb-2">Unique Airframes</p>
        </motion.div>

        <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.6 }}>
          <p className="text-5xl font-black text-white mb-2">{stats.uniqueTailNumbers}</p>
          <p className="text-indigo-300 text-lg font-bold uppercase tracking-widest mb-4">Different Tail Numbers</p>
        </motion.div>
