    ...
    >
      ...
      <header className="mb-12">
        ...
        <p className="text-xl leading-relaxed">
          LogbookWrapped is an independent tool created for entertainment and personal visualization. 
        ...
        <section className="bg-orange-500/10 border border-orange-500/20 p-8 rounded-2xl flex gap-6 items-start">
          ...
          <div>
            ...
            <p className="text-lg leading-relaxed">
              The statistics and visuals generated by LogbookWrapped <strong>do not constitute official aviation records</strong>. 
        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <section className="bg-slate-800/40 border border-slate-700/50 p-8 rounded-2xl">
            ...
            <p className="leading-relaxed text-slate-400">
              LogbookWrapped is not affiliated with, endorsed by, or sponsored by 
