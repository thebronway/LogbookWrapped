...
export const Page5_Superlatives: React.FC<Props> = ({ stats, exportFormat = 'story' }) => {
  ...
  return (
    ...
    >
      <h2 className={`${exportFormat === 'post' ? (isLongLine1 ? 'text-2xl mb-6' : 'text-3xl mb-6') : (isLongLine1 ? 'text-2xl mb-10' : 'text-3xl mb-10')} font-black tracking-tight text-fuchsia-400 leading-tight`}>
        {line1}<br />
